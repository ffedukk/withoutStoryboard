...
//    MARK: LifeCycle
    ...
    override func viewDidLoad() {
        ...
        barButton = UIBarButtonItem(barButtonSystemItem: .done, target: nil, action: #selector(buttonPressed))
...
extension ViewController: HeaderDelegateProtocol {
    func addRowInSection(section: Int) {
        ...
        tableView.insertRows(at: [IndexPath(row: 0, section: section)], with: .bottom)
    }
}
...
extension ViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        header.setHeader(with: currentSectionModel, width: view.frame.size.width, height: headerHeigh, sectionIndex: section)
        return header
    }
